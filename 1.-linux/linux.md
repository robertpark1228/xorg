...
_bwa, samtools, gatk(java), (RAW QC-trimmomatic, trim_galore), hisat2 ,star, cufflinks(R) 등…_
...
**cat \[파일명] : 파일의 내부 텍스트 출력(zcat-gzip/”bcftools-only_vcf”-<1%)**
...
1. **다운로드 – 압축해제 – make 로 컴파일 후 설치,**\
   **htslib->make / 어떻게 만들어라 -> 메뉴얼**
...
1. pip install 사용/ ie) pip2 또는 pip3 트라이 가능(파이쏜 버전에 따름)\

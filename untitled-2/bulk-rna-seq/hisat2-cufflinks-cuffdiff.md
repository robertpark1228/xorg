...
{% content-ref url="hisat2-mapping-+-seqmonk.md" %}
[hisat2-mapping-+-seqmonk.md](hisat2-mapping-+-seqmonk.md)
{% endcontent-ref %}
...
([http://compbio.mit.edu/cummeRbund/manual\_2\_0.html](http://compbio.mit.edu/cummeRbund/manual\_2\_0.html))\
(\
\
\
...
![disp<-dispersionPlot(genes(cuff))](<../../.gitbook/assets/image (161).png>)
